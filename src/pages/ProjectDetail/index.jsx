        ...
        return (
            ...
            <div className="project">
                ...
                <div className="project-demo" >
                    <CustomButton text={"View Demo"} link={"https://cfd-shoper.vercel.app/"} />
                </div>
                <Grid container className="section pb-45 top_30">
                    ...
                    <Grid item xs={12}>
                        ...
                        <div className="row mt-2">
                            ...
                            <p className="col-9" style={{ wordBreak: "break-word" }}><a href={dataShoper.projectInfo.link} target="_blank">https://cfd-shoper.vercel.app/</a></p>
                        </div>
                        <div className="row mt-2">
                ...
                <Grid container className="section pb-45 top_30">
                    ...
                    <Grid item xs={12}>
                        ...
                        <div className="row mt-2">
                            <strong className="col-3" style={{ textAlign: "right" }}>Filter</strong>
                            <p className="col-9" style={{ wordBreak: "break-word" }}>{dataShoper.projectFunc.filter}</p>
                        </div>
                        <div className="row mt-2">
